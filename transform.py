...
def show_cloud_tops(show_background=False):
    ...
    sample_ds = xr.load_dataset("12_02_10_B1.nc", engine="netcdf4")
...
if True:
    compare_transform('12_03_10_A2.nc', '12_03_10_B2.nc')
    compare_transform('12_02_10_A3.nc', '12_02_10_B1.nc')
    compare_transform('12_04_10_A1.nc', '12_04_10_B3.nc')



for fname in glob.glob('12*.nc'):
    sample_ds = xr.load_dataset(fname, engine="netcdf4")
    lat, lon, height, height_a = transform_cloud_edge(sample_ds)
    my_dict = { 'lat': lat, 'lon': lon, 'height': height}
    outfname = 'Q'+fname.replace('.nc','.pkl')
